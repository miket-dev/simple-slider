...
class Slider extends Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    if (this.props.value !== nextProps.value) {
      let x =
        this.sliderElement.parentElement.offsetLeft +
        this.mouseHandler.setPosition(nextProps.value) -
        this.initialX;
  ...
  handleRangeClick = e => {
    let position = this.mouseHandler.currentMousePosition(e);
    let x =
      this.sliderElement.parentElement.offsetLeft + position.x - this.initialX;
  ...
  render() {
    let animate =
      !this.state.dragging || (this.state.dragging && this.props.steps);
    let sliderElement = (
      <div
        className={"slider_element " + ((animate && "animate") || null)}
        ref={val => (this.sliderElement = val)}
    ...
    return (
      <div
        className={
          "slider_container " + (this.props.disabled && "disabled") || null
        }
      >
        {sliderElement}
        <Range
